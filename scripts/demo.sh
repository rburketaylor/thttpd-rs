...
python3 -m pytest harness/tests/ --ignore=harness/tests/test_differential.py --collect-only -q | tail -1
...
printf '\n3. Full proof\n'
printf 'Run make verify for format, lint, unit, security, legacy, and parity gates.\n'
