...
pub struct Cli {
    ...
    #[arg(long = "nov", conflicts_with = "vhost")] pub no_vhost: bool,
    #[arg(long = "vhost", conflicts_with = "no_vhost")] pub vhost: bool,
...
impl ServerConfig {
    pub fn from_cli(cli: &Cli) -> Self {
        Self {
            ...
            // Default matches C: vhost=false unless explicitly enabled
            vhost: cli.vhost && !cli.no_vhost,
